...
ALLOWED_HOSTS = ["ai-prep-3cnt.onrender.com", "localhost", "127.0.0.1"]
...
if USE_LOCAL_DB:
    ...
    # `ssl_require=True` adds `sslmode` which breaks SQLite connections.
    ...
    raise ImproperlyConfigured(
        "DATABASE_URL is not set and USE_LOCAL_DB is False"
    )
# Password validation
