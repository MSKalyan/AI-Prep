    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-white text-black">
      ...
      <aside className="w-64 border-r border-gray-200 hidden md:flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold tracking-tight">AI Exam Prep</h2>
        </div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-gray-200 text-xs text-gray-500">AI Exam Platform</div>
      </aside>
